...
internal static class Program
{
    private static readonly Dictionary<(int, int), Func<bool, Solution>> Solutions = new()
    {
        ...
        { (13, 2), useTestInput => new Day13.Part2(useTestInput) },
        
        { (14, 1), useTestInput => new Day14.Part1(useTestInput) },
        { (14, 2), useTestInput => new Day14.Part2(useTestInput) },
        
        { (15, 1), useTestInput => new Day15.Part1(useTestInput) },
        { (15, 2), useTestInput => new Day15.Part2(useTestInput) },
        
        { (16, 1), useTestInput => new Day16.Part1(useTestInput) },
        
        { (17, 1), useTestInput => new Day17.Part1(useTestInput) },
        { (17, 2), useTestInput => new Day17.Part2(useTestInput) },
    };
